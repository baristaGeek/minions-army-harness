...
@dataclass
class SpeckitSpecificationStep:
    name: str = "speckit-specification"
    skip: bool = False

    def execute(self, context: PipelineContext) -> None:
        def action() -> None:
            result = context.require_result()
            prompt = agent_execution._build_agent_prompt(context, result, "specification")
            ...
            agent_execution._store_agent_output(context, result, "specification", raw_output)
