...
@dataclass
class SpeckitImplementationStep:
    name: str = "speckit-implementation"
    skip: bool = False

    def execute(self, context: PipelineContext) -> None:
        def action() -> None:
            result = context.require_result()
            prompt = agent_execution._build_agent_prompt(context, result, "implementation")
            ...
            agent_execution._store_agent_output(context, result, "implementation", raw_output)
